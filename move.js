function move(t, e, n, r, a) {
    if (t) {
        ...
        for (var i in e)
            o[i] = {},
            "opacity" == i ? (o[i].b = Math.round(100 * css(t, i)),
            o[i].c = 100 * e[i] - o[i].b) : (o[i].b = parseInt(css(t, i)),
            o[i].c = e[i] - o[i].b);
        var r = r || "linear"
          , s = (new Date).getTime();
        t.iTimer = setInterval(function() {
            ...
            for (var i in e) {
                ...
                "opacity" == i ? (t.style[i] = c / 100,
                t.style.filter = "alpha(opacity=" + c + ")") : t.style[i] = c + "px"
            }
            n == u && (clearInterval(t.iTimer),
            a && a.call(t))
        }
        , 16)
    }
...
function css(t, e) {
    if ("scale" == e || "rotate" == e || "rotateX" == e || "rotateY" == e || "rotateZ" == e || "scaleX" == e || "scaleY" == e || "translateY" == e || "translateX" == e || "translateZ" == e)
        switch (t.$Transform || (t.$Transform = {}),
        e) {
        case "scale":
        case "scaleX":
        case "scaleY":
...
var Tween = {
    ...
    elasticIn: function(t, e, n, r, a, u) {
        ...
        !a || a < Math.abs(n)) {
            ...
            var o = u / (2 * Math.PI) * Math.asin(n / a);
